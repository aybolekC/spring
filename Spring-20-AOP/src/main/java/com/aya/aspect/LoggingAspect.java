...
//    @Pointcut("execution(* com.aya.controller.CourseController.*(..))")
...
//    @Before("execution(* com.aya.controller.CourseController.*(..))")
//    public void beforeAdvice(){
//        logger.info("Logger info ------");
//    }

//    @Pointcut("execution(* com.aya.repository.CourseRepository.findById(*))")
...
//    //within
//    @Pointcut("within(com.aya.controller..*)")
...
//    }
    ...
    @Pointcut("@annotation(com.aya.annotation.Loggable)")
